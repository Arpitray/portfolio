...
function Projects() {
  ...
  background: "#F3E4D3" // Use the imported image as background
     ...
     {id: 6,
      title: "Choppa : Watch together in real-time",
      description: "Engineered Choppa, a real-time streaming app built with Next.js, WebRTC, and Socket.io to enable low-latency peer-to-peer media sharing. Implemented a frame-accurate sync engine, scalable signaling for room/peer management, and modular React hooks to simplify WebRTC lifecycles — delivering a production-ready platform optimized for high concurrency and seamless user experience.",
      tags: [
  "#RealTimeApp",
  "#StreamingApp",
  "#PeerToPeer",
...
,
      video: "https://res.cloudinary.com/dsjjdnife/video/upload/v1767353884/Untitled_design_yxjrng",
      link: "#",
      githubLink: "https://github.com/Arpitray/frontsocket",
      liveDemoLink: "https://choppa.arpitray.me",
          ...
          return (
            ...
            >
              ...
              <div 
                ...
                className='flex-1 flex items-center justify-center w-full md:w-1/2 relative h-auto md:h-[98vh] rounded-2xl overflow-visible px-6 md:px-2 py-6 md:py-12 md:mt-0'
                onMouseEnter={() => window.dispatchEvent(new CustomEvent('cursorGlass:customText', { detail: 'VIEW' }))}
                onMouseLeave={() => window.dispatchEvent(new CustomEvent('cursorGlass:customText', { detail: null }))}
              >
